# Polymer nanocomposites ML Model
...
## Main Features
- Dataset manually assembled from ~20 peer-reviewed research studies (not present in this repository)
- Data exploration and preprocessing
- Multiple model iterations (RF_1 → RF_4)
- Best performing model: **RF_4**
- Prediction of:
  - Elastic modulus
  - Tensile strength
